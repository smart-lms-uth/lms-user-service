...
public record CourseActivityResponse(
    ...
    private static String extractResourceName(Map<String, Object> metadata, String pageTitle) {
        if (metadata != null) {
            ...
            if (metadata.containsKey("courseName"))
                return (String) metadata.get("courseName");
            if (metadata.containsKey("sectionName"))
                return (String) metadata.get("sectionName");
            if (metadata.containsKey("moduleName"))
                return (String) metadata.get("moduleName");
            if (metadata.containsKey("lessonName"))
                return (String) metadata.get("lessonName");
            if (metadata.containsKey("quizName"))
                return (String) metadata.get("quizName");
            if (metadata.containsKey("assignmentName"))
                return (String) metadata.get("assignmentName");
            if (metadata.containsKey("videoTitle"))
                return (String) metadata.get("videoTitle");
            if (metadata.containsKey("videoName"))
                return (String) metadata.get("videoName");
            if (metadata.containsKey("resourceName"))
                return (String) metadata.get("resourceName");
        }
    ...
    private static Long extractResourceId(Map<String, Object> metadata) {
        ...
        if (id == null)
            id = metadata.get("sectionId");
        if (id == null)
            id = metadata.get("moduleId");
        if (id == null)
            id = metadata.get("quizId");
        if (id == null)
            id = metadata.get("assignmentId");
        if (id == null)
            id = metadata.get("resourceId");
