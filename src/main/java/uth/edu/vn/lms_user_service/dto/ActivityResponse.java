...
public record ActivityResponse(
    ...
    public static ActivityResponse fromEntity(UserActivity activity) {
        return new ActivityResponse(
                ...
                activity.getTimestamp() != null ? activity.getTimestamp().atZone(VIETNAM_ZONE).toInstant() : null,
    ...
    public static ActivityResponse pending(Long userId, String sessionId, String activityType,
            String action, String pageUrl, String pageTitle, java.time.Instant timestamp) {
        return new ActivityResponse(
